...
import type { LearningTask, MistakeEntry, QuizSession } from '../types/models.js';
...
export function markLearningTaskReady(id: string, payload: { quizSessionId: string; questionCount: number }) {
